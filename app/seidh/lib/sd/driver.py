...
import numpy as np
from data.amber import amber_types, masses, charges
import data.vdw as vdw
import data.cov as cov
...
def SeidhAdapt(molecule):
	...
	return(coordinates,elec_charges,vdw_energies,vdw_radii,cov_radii) 